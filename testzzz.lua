...
function Library:CreateWindow(...)
    ...
    -- Example content
    local ExampleContent = Library:Create('Frame', {
    ...
    function Window:AddTab(Name)
        ...
        local RightSideLayout = Library:Create('UIListLayout', {
        ...
        RightSideLayout:GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
            RightSide.CanvasSize = UDim2.new(0, 0, 0, RightSideLayout.AbsoluteContentSize.Y)
        end);
